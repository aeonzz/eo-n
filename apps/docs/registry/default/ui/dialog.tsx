  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "bg-background ring-border ring-offset-background fixed left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg ring-2 ring-offset-1 transition-all duration-150 ease-out outline-none data-[ending-style]:top-[50.25%] data-[ending-style]:translate-y-[-49.75%] data-[ending-style]:scale-96 data-[ending-style]:opacity-0 data-[starting-style]:top-[50.25%] data-[starting-style]:translate-y-[-49.75%] data-[starting-style]:scale-96 data-[starting-style]:opacity-0 sm:max-w-lg scale-[calc(1-0.1*var(--nested-dialogs))] top-[calc(50%+1.25rem*var(--nested-dialogs))]",
          className
        )}
        {...props}
      >
