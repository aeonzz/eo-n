    ...
    <DropdownMenuPortal>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground h-full max-h-[var(--available-height)] w-full min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md transition-[transform,scale,opacity] duration-150 ease-out",
