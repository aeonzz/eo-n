...
export async function GithubInfo({
  ...
  return (
    <a
      ...
      {...props}
      className={cn(
        "text-fd-foreground/80 bg-fd-accent/50 hover:text-fd-accent-foreground hover:bg-fd-accent flex flex-col gap-1.5 rounded-lg px-4 text-sm transition-colors lg:flex-row lg:items-center",
        props.className
      )}
    >
